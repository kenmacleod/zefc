...
**Dispatch ABI:** Known names use closed-world `ZEFC_SEL_*` integer literals; late/dynamic names use `ZEFC_SITE("…")` cells. `ZEFC_SEND*` uses per-site **method IC** (guard + cached callee). Fields use typed **field IC**. See [docs/dispatch-and-loading.md](../../docs/dispatch-and-loading.md).
